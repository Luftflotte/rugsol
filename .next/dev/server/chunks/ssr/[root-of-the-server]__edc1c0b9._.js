...
"[project]/lib/solana/connection.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-rsc] (ecmascript)");
;
...
const connection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Connection"](HELIUS_RPC_URL, "confirmed");
async function getTokenMintInfo(address) {
    try {
        const mintPublicKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](address);
...
async function fetchTokenContext(address) {
    try {
        const mintPublicKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](address);
        const accountInfo = await connection.getParsedAccountInfo(mintPublicKey);
...
"[project]/lib/external/price.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/connection.ts [app-rsc] (ecmascript)");
;
async function calculateMarketCap(mintAddress, priceUsd) {
    // Special case for native SOL supply (~589M)
    if (mintAddress === "So11111111111111111111111111111111111111111" || mintAddress === "So11111111111111111111111111111111111111112") {
        return priceUsd * 589000000;
    }
    try {
        const mintInfo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTokenMintInfo"])(mintAddress);
...
async function getTokenPrice(mintAddress) {
                ...
                if (priceUsd > 0) {
                    ...
                    return {
                        ...
                        priceChange: {
                            ...
                            h1: 0,
                            h6: 0,
                            h24: parseFloat(h24Change.toFixed(2))
                        },
                        pairCreatedAt: 0
                    };
                }
    ...
    const effectiveAddress = mintAddress === "So11111111111111111111111111111111111111111" ? "So11111111111111111111111111111111111111112" : mintAddress;
...
"[project]/lib/external/jupiter-swap.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkSellSimulation(tokenAddress) {
    ...
    try {
        ...
        return {
            isHoneypot: false,
            simulationSuccess: false,
            reason: "Check failed (Network/API Error)"
        };
    }
}
}),
"[project]/lib/solana/authority.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function checkMintAuthority(context) {
    ...
    return {
        status: "fail",
        value: context.mintAuthority
    };
}
function checkFreezeAuthority(context) {
    ...
    return {
        status: "fail",
        value: context.freezeAuthority
    };
}
}),
"[project]/lib/solana/holders.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function fetchLargestAccountsViaDAS(mintAddress) {
    ...
    const sorted = data.result.token_accounts.sort((a, b)=>Number(BigInt(b.amount) - BigInt(a.amount)));
    return sorted.map((acc)=>({
            address: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](acc.address),
            amount: acc.amount,
            owner: acc.owner
        }));
}
async function analyzeHolders(mintAddress, totalSupply, excludeOwners = []) {
    try {
        const mintPublicKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](mintAddress);
        ...
        try {
            ...
            largestAccounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getTokenLargestAccounts(mintPublicKey);
        ...
        if (usedDASFallback) {
            ...
            for (const account of accountsToProcess){
                try {
                    const accountInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getParsedAccountInfo(account.address);
                    if (!accountInfo.value || !("parsed" in accountInfo.value.data)) {
                        continue;
                    }
                    const info = accountInfo.value.data.parsed.info;
        ...
        const topTenPercent = nonLpHolders.slice(0, 10).reduce((sum, holder)=>sum + holder.percent, 0);
        // Find largest non-LP holder
        const largestHolder = nonLpHolders.length > 0 ? {
...
"[project]/lib/external/liquidity.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/connection.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$price$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/price.ts [app-rsc] (ecmascript)");
;
;
;
...
async function checkLpBurned(pairAddress) {
    try {
        const pairPublicKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](pairAddress);
        // Check if it's a valid token mint account first
        const accountInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getParsedAccountInfo(pairPublicKey);
        ...
        const largestAccounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getTokenLargestAccounts(pairPublicKey);
...
async function getLpTotalSupply(pairAddress) {
    try {
        const pairPublicKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](pairAddress);
        const mintInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getParsedAccountInfo(pairPublicKey);
...
async function fetchBirdeyeSecurity(mintAddress) {
    if (!BIRDEYE_API_KEY) {
        return null;
    }
    try {
...
async function fetchBirdeyeLiquidity(mintAddress) {
    if (!BIRDEYE_API_KEY) return 0;
    try {
        const response = await fetch(`https://public-api.birdeye.so/defi/v3/token/market-data?address=${mintAddress}`, {
            headers: {
                "X-API-KEY": BIRDEYE_API_KEY,
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
            }
...
async function fetchPumpFunMarketCap(mintAddress) {
    try {
...
async function checkGraduatedPumpToken(mintAddress) {
    try {
...
async function fetchJupiterLiquidity(mintAddress) {
    ...
    try {
        ...
        if (Array.isArray(data) && data.length > 0) {
            ...
            const token = data.find((t)=>t.address === mintAddress) || data[0];
...
async function findRaydiumPoolViaRPC(mintAddress) {
    try {
        const mint = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](mintAddress);
        // Strategy: Check if any of the top 20 holders are DEX vaults
        // This is much lighter on RPC than getProgramAccounts
        const largestAccounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getTokenLargestAccounts(mint);
        ...
        const KNOWN_DEX_OWNERS = new Set([
            ...
            "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8",
            "CPMMOO8L3FXFWJLTR2E2j15fXW4g1peYjF8zL3fE53H",
            "LBUZKhRxPF3XUpBCjp4YzTKgLccjZhTSDM9YuVaPwxo",
            "whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc",
            "9W959DqEETiGZocYWCQPaJ6sBmUzgfxXfqGeTEdp3aQP",
            "CAMMCzo5YL8w4VFF8ESWg8KS2uBlAMFHKq4zzMoERHvi"
        ]);
        for (const account of largestAccounts.value){
            // We need to fetch the account info to see the owner
            const info = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getParsedAccountInfo(account.address);
...
async function checkLiquidity(mintAddress, prefetchedDexData) {
    try {
        let liquidityUsd = 0;
        let dexName = null;
        ...
        if (liquidityUsd === 0) {
            ...
            if (jupLiq > 0) {
                ...
                const jupPrice = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$price$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchJupiterPrice"])(mintAddress);
                if (jupPrice && jupPrice.priceUsd > 0) {
...
"[project]/lib/external/metadata.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$liquidity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/liquidity.ts [app-rsc] (ecmascript)");
;
;
const HELIUS_API_KEY = process.env.HELIUS_API_KEY;
...
async function fetchJupiterMetadata(mintAddress) {
...
async function fetchHeliusMetadata(mintAddress) {
    ...
    try {
        ...
        const result = {
            name: data.content?.metadata?.name || offChainData.name || null,
            symbol: data.content?.metadata?.symbol || offChainData.symbol || null,
            image: data.content?.links?.image || offChainData.image || null,
            description: data.content?.metadata?.description || offChainData.description || null,
            website: data.content?.links?.external_url || offChainData.external_url || null,
...
async function fetchDexScreenerProfile(mintAddress) {
    try {
        ...
        const profileResponse = await fetch(`https://api.dexscreener.com/token-profiles/latest/v1/solana/${mintAddress}`, {
            headers: {
                "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"
            }
        });
        if (profileResponse.ok) {
            ...
            if (Array.isArray(profiles) && profiles.length > 0) {
                ...
                return {
                    ...
                    website: p.links?.find((l)=>l.type === 'website')?.url || null,
                    twitter: p.links?.find((l)=>l.type === 'twitter')?.url || null,
                    telegram: p.links?.find((l)=>l.type === 'telegram')?.url || null
                };
            }
        }
        return null;
...
async function fetchPumpFunMetadata(mintAddress) {
    if (process.env.SKIP_EXTERNAL_FETCH === "true") return null;
    try {
        const response = await fetch(`https://frontend-api.pump.fun/coins/${mintAddress}`, {
            method: "GET",
...
async function checkMetadataIsMutable(mintAddress) {
    if (!HELIUS_API_KEY) {
        return true; // Assume mutable if we can't check
    }
    try {
        // Derive Metaplex metadata PDA
        const METADATA_PROGRAM_ID = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"]("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
        const mintPubkey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](mintAddress);
        const [metadataPDA] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"].findProgramAddressSync([
...
async function getTokenMetadata(mintAddress) {
    try {
        // Validate address
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](mintAddress);
        ...
        const [heliusData, pumpFunData, dexData, dexProfileData] = await Promise.all([
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$liquidity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchDexScreener"])(mintAddress),
...
"[project]/lib/solana/pumpfun.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "default",
    ()=>__TURBOPACK__default__export__,
    "getPumpFunCurveState",
    ()=>getPumpFunCurveState
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/connection.ts [app-rsc] (ecmascript)");
;
;
const PUMP_FUN_PROGRAM_ID = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"]("6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P");
...
async function getPumpFunCurveState(mintAddress) {
    try {
        const mintPk = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](mintAddress);
        const [pda] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"].findProgramAddressSync([
            Buffer.from("bonding-curve"),
            mintPk.toBuffer()
        ], PUMP_FUN_PROGRAM_ID);
        const pdaInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getAccountInfo(pda);
        if (!pdaInfo || !pdaInfo.data) {
            return {
                ...
                marketCapSol: null,
                curveProgressPercent: null,
                remainingSolToGraduate: null
            };
        }
...
const __TURBOPACK__default__export__ = getPumpFunCurveState;
}),
"[project]/lib/solana/tokenAge.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkTokenAge(mintAddress, pairCreatedAt) {
    try {
        ...
        const signatures = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connection"].getSignaturesForAddress(mintPublicKey, {
            limit: 1000
        }, "confirmed");
...
async function getAgeFromAccountInfo(mintAddress) {
...
"[project]/lib/scoring/whitelist.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const WHITELIST_MAP = new Map(WHITELISTED_TOKENS.map((token)=>[
        token.address,
        token
    ]));
...
function getWhitelistedToken(address) {
    return WHITELIST_MAP.get(address);
}
}),
"[project]/lib/external/jupiter-tokens.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function isJupiterVerified(address) {
    const tokens = await fetchVerifiedTokens();
    return tokens.has(address);
}
async function getJupiterTokenInfo(address) {
    const tokens = await fetchVerifiedTokens();
...
function getTokenType(token) {
    ...
    // Stablecoins
    if (tags.includes("stablecoin") || symbol.includes("usd") || symbol.includes("usdt") || symbol.includes("usdc") || symbol.includes("dai")) {
        return "stablecoin";
    }
    // Wrapped tokens
...
"[project]/lib/scoring/constants.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/scoring/engine.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$price$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/price.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$jupiter$2d$swap$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/jupiter-swap.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$authority$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/authority.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$holders$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/holders.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$liquidity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/liquidity.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$metadata$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/metadata.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$pumpfun$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/pumpfun.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$tokenAge$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/tokenAge.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$whitelist$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/scoring/whitelist.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$jupiter$2d$tokens$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/external/jupiter-tokens.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/solana/connection.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@solana/web3.js/lib/index.esm.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/scoring/constants.ts [app-rsc] (ecmascript)");
;
;
;
;
...
;
// --- Helpers ---
async function safeCheck(checkFn, checkName) {
    try {
        const result = await checkFn();
        return {
            status: result === null ? "unknown" : "success",
            data: result
        };
    } catch (error) {
...
function getGrade(score, hasCriticalFail) {
    if (hasCriticalFail) return {
        grade: "F",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].F
    };
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].A.min) return {
        grade: "A",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].A
    };
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].B.min) return {
        grade: "B",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].B
    };
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].C.min) return {
        grade: "C",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].C
    };
    if (score >= __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].D.min) return {
        grade: "D",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].D
    };
    return {
        grade: "F",
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["GRADES"].F
...
// --- Analysis Helpers ---
function analyzeDevWallet(metadata, holders) {
...
async function detectTokenMode(tokenAddress, pumpState, context, isWhitelisted = false) {
    ...
    try {
        const mintPk = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"](tokenAddress);
        const PUMP_PROGRAM = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"]("6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P");
        const [bondingCurvePda] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PublicKey"].findProgramAddressSync([
            Buffer.from("bonding-curve"),
            mintPk.toBuffer()
        ], PUMP_PROGRAM);
        if (context) {
    ...
    try {
        const dexData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$liquidity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchDexScreener"])(tokenAddress);
        if (dexData) {
...
function calculatePenalties(checks, mode, whitelist) {
    const penalties = [];
    ...
    if (!skip.liquidity && checks.liquidity.data) {
        ...
        // We'll leave it as UI warning for now to avoid over-penalizing new tokens.
            ...
            if (liq.lpSizeUsd === -1) {
                ...
                penalties.push({
                    category: "Low Liquidity",
                    reason: `Liquidity is critically low ($${liq.lpSizeUsd.toLocaleString()})`,
                    points: 30
                });
            } else if (liq.lpSizeUsd < 10000) {
                penalties.push({
                    category: "Low Liquidity",
                    reason: `Liquidity is low ($${liq.lpSizeUsd.toLocaleString()})`,
                    points: 20
                });
            } else if (liq.lpSizeUsd < 50000) {
                penalties.push({
                    category: "Low Liquidity",
                    reason: `Liquidity is moderate ($${liq.lpSizeUsd.toLocaleString()})`,
                    points: 10
                });
            }
    ...
    if (!skip.holders && checks.holders.data) {
        ...
        if (singlePenalty > top10Penalty) {
            penalties.push({
                category: "Top Holder Risk",
                reason: `${singleReason} (Top 10: ${topTenPercent.toFixed(1)}%)`,
                points: singlePenalty
            });
        } else if (top10Penalty > 0) {
            penalties.push({
                category: "Top Holder Risk",
                reason: `${top10Reason} (Largest: ${largestHolder?.percent.toFixed(1)}%)`,
                points: top10Penalty
            });
        }
    ...
    if (mode !== "pump" && !skip.metadata) {
        if (checks.metadata.data?.isMutable) {
            penalties.push({
                category: "Mutable Metadata",
                reason: "Metadata is mutable",
                points: 5
            });
        }
...
async function _scanTokenImpl(tokenAddress) {
    // 1. Whitelist Check
    let whitelist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$whitelist$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWhitelistedToken"])(tokenAddress);
    let jupiterVerified = false;
    if (!whitelist) {
        const jupInfo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$jupiter$2d$tokens$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getJupiterTokenInfo"])(tokenAddress);
        if (jupInfo) {
            ...
            whitelist = {
                ...
                type: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$jupiter$2d$tokens$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTokenType"])(jupInfo),
                skipChecks: {
                    age: true
                },
                minScore: 60
    ...
    const WSOL_ADDRESS = "So11111111111111111111111111111111111111112";
    const pumpStatePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$pumpfun$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(tokenAddress);
    const pricePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$price$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTokenPrice"])(tokenAddress).catch((e)=>{
        console.warn("Price fetch failed:", e);
        return null;
    });
    const solPricePromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$price$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTokenPrice"])(WSOL_ADDRESS);
    const contextPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$connection$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchTokenContext"])(tokenAddress);
    ...
    const [mintAuth, freezeAuth, holders, liquidity, metadata, tokenAge, price, honeypot] = await Promise.all([
        safeCheck(()=>context ? Promise.resolve((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$authority$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkMintAuthority"])(context)) : Promise.resolve(null), "mintAuthority"),
        safeCheck(()=>context ? Promise.resolve((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$authority$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkFreezeAuthority"])(context)) : Promise.resolve(null), "freezeAuthority"),
        safeCheck(async ()=>{
            if (!context) return null;
            // Exclude bonding curve PDA from holders analysis
            const excludes = pumpState?.exists ? [
                pumpState.pda
            ] : [];
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$holders$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["analyzeHolders"])(tokenAddress, context.supply, excludes);
        }, "holders"),
        safeCheck(async ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$liquidity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkLiquidity"])(tokenAddress, dexData);
        }, "liquidity"),
        safeCheck(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$metadata$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTokenMetadata"])(tokenAddress), "metadata"),
        safeCheck(async ()=>{
            const p = await pricePromise;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$solana$2f$tokenAge$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkTokenAge"])(tokenAddress, p?.pairCreatedAt);
        }, "tokenAge"),
        safeCheck(()=>pricePromise, "price"),
        safeCheck(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$external$2f$jupiter$2d$swap$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkSellSimulation"])(tokenAddress), "honeypot")
    ]);
    ...
    return {
        ...
        whitelistInfo: whitelist ? {
            ...
            type: jupiterVerified ? `jupiter-verified (${whitelist.type})` : whitelist.type
        } : undefined,
        price: price.data,
...
"[project]/lib/storage/recent-scans.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/scan/[address]/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateMetadata({ params }) {
    ...
    const siteUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$url$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBaseUrl"])();
    // Default fallback
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isValidSolanaAddress"])(address)) {
        return buildMetadata(tokenName, description, ogImageUrl);
    }
    // 1) Try cached scan data first (instant, no API calls)
    const cached = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2f$recent$2d$scans$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRecentScanByAddress"])(address);
    if (cached?.ogQuery) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scoring$2f$engine$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["scanToken"])(address);
...
function buildMetadata(tokenName, description, ogImageUrl) {
    return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__edc1c0b9._.js.map